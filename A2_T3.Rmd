...
The Big Island of Hawai'i is one of the most biodiverse places on Earth. There are many different types of biomes and microclimates on the island that support and abundance of wild flora and fauna, as well as human uses. In this analysis, land use and cover is generalized and visualized into three separate categories: Agriculture, Urban/Residential/Commercial, and Natural. These categories were developed by combining 27 specified land uses and coverage types.
